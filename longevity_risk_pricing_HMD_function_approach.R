...
# setup function
# includes the same steps as the preceding sub-chapter but is used to create
# a sensitivity table of maturities and starting ages
pricing_calculation <- function(t_0_year = 2023,
                                maturity = 10,
                                l_0 = 10,
                                x_0 = 65,
                                mx_gender = mxM,
                                ...
                                input_n_simulations = 100,
                                input_drift_type = "window",
                                input_drift_window = 20,
                                input_sigma_type = "full",
                                input_sigma_window = 20,
...
# start_year = 2019
# pricing_calculation(t_0_year = start_year, 
#                     maturity = 10,
#                     l_0 = 10,
#                     x_0 = 65,
#                     mx_gender = mxM,
